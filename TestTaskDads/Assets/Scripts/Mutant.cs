...
public class Mutant : MonoBehaviour, IPawn
{
    ...
    private AudioSource _mutantAudio;
    ...
    {
        _mutantAudio.PlayOneShot(_hits[Random.Range(0, _hits.Length - 1)]);
    ...
    void Awake()
    {
        ...
        _mutantAudio = GetComponent<AudioSource>();
    }
